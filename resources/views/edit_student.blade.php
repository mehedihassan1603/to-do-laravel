...
<body class="container mx-auto py-8">
    ...
    <form action="{{ route('update_student') }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="text" id="name" name="name" required value="{{ $student_info->name }}"
                class="border border-gray-300 rounded-md px-3 py-2 w-full">
        </div>
        <div class="mb-4">
            <label for="father_name" class="block font-semibold">Father's Name:</label>
            <input type="text" id="father_name" name="father_name" required value="{{ $student_info->father_name }}"
                class="border border-gray-300 rounded-md px-3 py-2 w-full">
        </div>
        <div class="mb-4">
            <label for="mother_name" class="block font-semibold">Mother's Name:</label>
            <input type="text" id="mother_name" name="mother_name" required value="{{ $student_info->mother_name }}"
                class="border border-gray-300 rounded-md px-3 py-2 w-full">
        </div>
        <div class="mb-4">
            <label for="phone_number" class="block font-semibold">Phone Number:</label>
            <input type="number" id="phone_number" name="phone_number" required value="{{ $student_info->phone_number }}"
                class="border border-gray-300 rounded-md px-3 py-2 w-full">
        </div>
        <div class="mb-4">
            <label for="email" class="block font-semibold">Email:</label>
            <input type="text" id="email" name="email" required value="{{ $student_info->email }}"
                class="border border-gray-300 rounded-md px-3 py-2 w-full">
        </div>
        <div class="mb-4">
            <label for="gpa" class="block font-semibold">GPA:</label>
            <input type="number" id="gpa" name="gpa" step="0.01" required value="{{ $student_info->gpa }}"
                class="border border-gray-300 rounded-md px-3 py-2 w-full">
        </div>
